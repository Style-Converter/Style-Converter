...
internal object borderInlineEndColor {
    fun applyBorderInlineEndColor(prop: String, value: JsonElement, acc: BaseIR): BaseIR {
        ...
        return acc.copy(border = current.copy(right = right.copy(color = color)))
    }
