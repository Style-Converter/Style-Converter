...
internal object borderTopRightRadius {
    fun applyBorderTopRightRadius(prop: String, value: JsonElement, acc: BaseIR): BaseIR {
        ...
        return acc.copy(border = current.copy(radius = radius.copy(topRightPx = px)))
    }
