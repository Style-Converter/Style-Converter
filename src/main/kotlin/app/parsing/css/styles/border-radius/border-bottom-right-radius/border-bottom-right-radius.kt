...
internal object borderBottomRightRadius {
    fun applyBorderBottomRightRadius(prop: String, value: JsonElement, acc: BaseIR): BaseIR {
        ...
        return acc.copy(border = current.copy(radius = radius.copy(bottomRightPx = px)))
    }
