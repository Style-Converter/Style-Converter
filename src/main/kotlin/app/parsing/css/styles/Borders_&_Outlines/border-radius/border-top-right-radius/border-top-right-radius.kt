...
fun parseBorderTopRightRadius(styles: JsonObject, acc: MutableList<PropertyIR>): MutableList<PropertyIR> {
	val raw = styles["border-top-right-radius"]?.jsonPrimitive?.contentOrNull ?: return acc
