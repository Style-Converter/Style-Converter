...
fun parseBorderRightColor(styles: JsonObject, acc: MutableList<PropertyIR>): MutableList<PropertyIR> {
	val raw = styles["border-right-color"]?.jsonPrimitive?.contentOrNull ?: return acc
