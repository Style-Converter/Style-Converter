...
fun parseBorderInlineEndColor(styles: JsonObject, acc: MutableList<PropertyIR>): MutableList<PropertyIR> {
	val raw = styles["border-inline-end-color"]?.jsonPrimitive?.contentOrNull ?: return acc
