...
fun parseBorderBottomWidth(styles: JsonObject, acc: MutableList<PropertyIR>): MutableList<PropertyIR> {
	val raw = styles["border-bottom-width"]?.jsonPrimitive?.contentOrNull ?: return acc
