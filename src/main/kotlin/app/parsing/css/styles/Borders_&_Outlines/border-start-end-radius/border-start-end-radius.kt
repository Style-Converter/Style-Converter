...
private fun define(input: String, acc: MutableList<PropertyIR>): MutableList<PropertyIR> {
	...
	// Logical start-end maps to top-right in LTR
	val name = "border-top-right-radius"
...
fun parseBorderStartEndRadius(styles: JsonObject, acc: MutableList<PropertyIR>): MutableList<PropertyIR> {
	val raw = styles["border-start-end-radius"]?.jsonPrimitive?.contentOrNull ?: return acc
