...
private fun define(input: String, acc: MutableList<PropertyIR>): MutableList<PropertyIR> {
	...
	// Logical end-end maps to bottom-right in LTR
...
fun parseBorderEndEndRadius(styles: JsonObject, acc: MutableList<PropertyIR>): MutableList<PropertyIR> {
	val raw = styles["border-end-end-radius"]?.jsonPrimitive?.contentOrNull ?: return acc
