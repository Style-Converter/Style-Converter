...
fun parseBorderBottomColor(styles: JsonObject, acc: MutableList<PropertyIR>): MutableList<PropertyIR> {
	val raw = styles["border-bottom-color"]?.jsonPrimitive?.contentOrNull ?: return acc
