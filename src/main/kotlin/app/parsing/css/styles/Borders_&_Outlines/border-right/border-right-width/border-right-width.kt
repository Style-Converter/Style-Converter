...
fun parseBorderRightWidth(styles: JsonObject, acc: MutableList<PropertyIR>): MutableList<PropertyIR> {
	val raw = styles["border-right-width"]?.jsonPrimitive?.contentOrNull ?: return acc
