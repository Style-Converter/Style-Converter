...
fun parseBorderInlineStartWidth(styles: JsonObject, acc: MutableList<PropertyIR>): MutableList<PropertyIR> {
	val raw = styles["border-inline-start-width"]?.jsonPrimitive?.contentOrNull ?: return acc
