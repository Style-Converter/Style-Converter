...
fun parseBorderSpacing(styles: JsonObject, acc: MutableList<PropertyIR>): MutableList<PropertyIR> {
	val raw = styles["border-spacing"]?.jsonPrimitive?.contentOrNull ?: return acc
