...
fun parseBorderTopLeftRadius(styles: JsonObject, acc: MutableList<PropertyIR>): MutableList<PropertyIR> {
	val raw = styles["border-top-left-radius"]?.jsonPrimitive?.contentOrNull ?: return acc
