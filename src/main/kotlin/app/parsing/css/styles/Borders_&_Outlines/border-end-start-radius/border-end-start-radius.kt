...
private fun define(input: String, acc: MutableList<PropertyIR>): MutableList<PropertyIR> {
	...
	// Logical end-start maps to bottom-left in LTR
...
fun parseBorderEndStartRadius(styles: JsonObject, acc: MutableList<PropertyIR>): MutableList<PropertyIR> {
	val raw = styles["border-end-start-radius"]?.jsonPrimitive?.contentOrNull ?: return acc
