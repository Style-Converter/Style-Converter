...
internal object paddingBlockShorthand {
    fun applyPaddingBlock(prop: String, value: JsonElement, acc: BaseIR): BaseIR {
        ...
        return acc.copy(spacing = spacing.copy(paddingTopPx = start, paddingBottomPx = end))
    }
