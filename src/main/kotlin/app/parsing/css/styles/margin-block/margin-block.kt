...
internal object marginBlockShorthand {
    fun applyMarginBlock(prop: String, value: JsonElement, acc: BaseIR): BaseIR {
        ...
        return acc.copy(spacing = spacing.copy(marginTopPx = start, marginBottomPx = end))
    }
